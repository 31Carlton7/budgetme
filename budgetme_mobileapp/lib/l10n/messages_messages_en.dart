...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(number) => "Please enter a value less than your required amount of \$${number}";

  static m2(month) => "${month} Dashboard";

  static m3(percent) => "You are ${percent} of the way there!";

  static m4(versionNumber) => "Version ${versionNumber}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "purchaseProText" : MessageLookupByLibrary.simpleMessage("Unlock unlimited Goals for just \$2.99 😆 Pay once, Pay forever!"),
    ...
    "unlockText" : MessageLookupByLibrary.simpleMessage("Unlock your true self with unlimited goals for a one-time purchase of just \$2.99! 😎"),
    "userPercentProgress" : m3,
