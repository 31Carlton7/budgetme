...
class L10n {
  ...
  String get dashboard =>
      Intl.message('Dashboard', name: 'dashboard', desc: '');

  ///
  String get monthlySavings =>
      Intl.message('Monthly Savings', name: 'monthlySavings', desc: '');

  ///
  String get remainingBalance =>
      Intl.message('Remaining Balance', name: 'remainingBalance', desc: '');

  ///
  String get totalSaved =>
      Intl.message('Total Saved', name: 'totalSaved', desc: '');

  ///
  String get savingsGoals =>
      Intl.message('Savings Goals', name: 'savingsGoals', desc: '');

  ///
  String get currentProgress =>
      Intl.message('Current Progress', name: 'currentProgress', desc: '');

  ///
  String userPercentProgress(String percent) =>
      Intl.message('You are $percent% of the way there!',
          name: 'userPercentProgress', args: [percent], desc: '');
  ...
  String get transactionHistory =>
      Intl.message('Transaction History', name: 'transactionHistory', desc: '');
  ...
  String get transaction =>
      Intl.message('Transaction', name: 'transaction', desc: '');
  ...
  String get deleteGoal =>
      Intl.message('Delete Goal', name: 'deleteGoal', desc: '');
  ...
  ///
  String get savingForQ =>
      Intl.message('What are you saving for?', name: 'savingForQ', desc: '');

  ///
  String get howMuchNeededQ => Intl.message('How much money is needed?',
      name: 'howMuchNeededQ', desc: '');

  ///
  String get whenDeadlineQ =>
      Intl.message('When is the deadline?', name: 'whenDeadlineQ', desc: '');

  ///
  String get howMuchSavedQ => Intl.message('How much money is currently saved?',
      name: 'howMuchSavedQ', desc: '');

  ///
  String get prefCurr => Intl.message('Select your Preferred Currency',
      name: 'prefCurr', desc: '');

  ///
  String get purchasePro =>
      Intl.message('Purchase Pro�', name: 'purchasePro', desc: '');

  ///
  String get purchaseProText => Intl.message(
      'Unlock unlimited Goals for just 2.99 USD 😆 Pay once, Pay forever',
      name: 'purchaseProText',
      desc: '');

  ///
  String get statistics =>
      Intl.message('July Statistics', name: 'statistics', desc: '');
  ...
  String get adjustMonthlySpendingLimit =>
      Intl.message('Adjust Monthly Spending Limit',
          name: 'adjustMonthlySpendingLimit', desc: '');
  ...
  String get privacyPolicy =>
      Intl.message('Privacy Policy', name: 'privacyPolicy', desc: '');
  ...
  String get unlimitedGoals =>
      Intl.message('Unlimited Goals', name: 'unlimitedGoals', desc: '');
  ...
  String get newMonthlySpendingLimit =>
      Intl.message('New Monthly Spending Limit',
          name: 'newMonthlySpendingLimit', desc: '');

  ///
  String get pressThePBtn =>
      Intl.message('Press the purple button to create a new Goal!',
          name: 'pressThePBtn', desc: '');
  ...
  ///
  String pleaseEnterLess(String currency, String number) => Intl.message(
      'Please enter a value less than your required amount of $currency$number',
      name: 'pleaseEnterLess',
  ...
  String get selectImage =>
      Intl.message('Select Image', name: 'selectImage', desc: '');

  ///
  String get searchForImage =>
      Intl.message('Search for images on Unsplash using the search bar',
          name: 'searchForImage', desc: '');

  ///
  String get noResults =>
      Intl.message('No Results', name: 'noResults', desc: '');
  ...
  ///
  String get hideFrom =>
      Intl.message('Hide from history', name: 'hideFrom', desc: '');

  ///
  String get deleteGoalQ =>
      Intl.message('Delete Goal?', name: 'deleteGoalQ', desc: '');

  ///
  String get areYouSureDelQ =>
      Intl.message('Are you sure want to delete your goal?',
          name: 'areYouSureDelQ', desc: '');
  ...
  String get noTransactions =>
      Intl.message('No transactions have been made...yet!',
          name: 'noTransactions', desc: '');

  ///
  String get congratulations =>
      Intl.message('Congratulations on completing your goal! �',
          name: 'congratulations', desc: '');

  ///
  String get startNewGoal =>
      Intl.message('Start new goal', name: 'startNewGoal', desc: '');

  ///
  String get outOfTime =>
      Intl.message('Out of time!', name: 'outOfTime', desc: '');
}
