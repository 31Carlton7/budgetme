...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m6(number) => "Versão ${number}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function> {
    ...
    "outOfTime" : MessageLookupByLibrary.simpleMessage("Fora do tempo!"),
    "pleaseEnterLess" : m1,
    ...
    "searchForImage" : MessageLookupByLibrary.simpleMessage("Pesquise imagens no Unsplash usando a barra de pesquisa"),
