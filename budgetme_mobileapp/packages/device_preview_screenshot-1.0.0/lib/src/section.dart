...
class DevicePreviewScreenshot extends StatefulWidget {
  ...
  @override
  State<DevicePreviewScreenshot> createState() => _DevicePreviewScreenshotState();
}
              ...
              return ListTile(
                ...
                onTap: _isLoading
                    ...
                    : () async {
                        ...
                        try {
                          final initialDevice = DevicePreview.selectedDevice(ctx);
                          for (var device in DevicePreview.availableDeviceIdentifiers(context)) {
